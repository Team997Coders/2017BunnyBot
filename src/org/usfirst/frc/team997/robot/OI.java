...
public class OI {
	...
	public final Joystick GamePad2, GamePad;

	public final JoystickButton
	// decellToggleButton,
	shiftButton, clawButton, clawButton2, reverseButton, MoveArmFwdButton, MoveArmRevButton, ZeroArmButton,
			GoToVerticalButton, ArmVerticalButton, ArmLevelForwardButton, ArmLevelBackwardButton, ArmFloorForwardButton,
			ArmFloorBackwardButton, ArmMidForwardButton, ArmMidBackwardButton;
	...
	public OI() {
		...
		clawButton2 = new JoystickButton(GamePad2, RobotMap.Ports.closeClaw2);
		...
		MoveArmRevButton = new JoystickButton(GamePad, RobotMap.Ports.ArmRevButton);
		MoveArmFwdButton.whileHeld(new MoveArm(-0.5));
		...
		// decellToggleButton = new JoystickButton(GamePad,
		// RobotMap.Ports.decellToggleButton);
