...
public class ArmToAngle extends Command {
	...
	// Preset Levels
	// public static ArmToAngle low() { return new
	// ArmToAngle(RobotMap.Values.armPosOne); }
	// public static ArmToAngle medium() { return new
	// ArmToAngle(RobotMap.Values.armPosTwo); }
	// public static ArmToAngle high() { return new
	// ArmToAngle(RobotMap.Values.armPosThree); }
	...
	protected void initialize() {
		/*
		 * if (!Robot.armJoint.isZeroed) { System.out.println("Not zeroed!"); end();
		 * cancel(); }
		 */
	...
	protected boolean isFinished() {
		...
		// Robot.armJoint.Motor.getOutputCurrent());
