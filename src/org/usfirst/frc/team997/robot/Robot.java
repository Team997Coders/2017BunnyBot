...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		chooser.addObject("P-Drive Test - Drive 12 feet at half power",
				new PDriveDistance(0.5, driveTrain.ticksPerFoot * 12.0));
		...
		// chooser.addObject("Test driveToDistance", new DriveToDistance(2872));
		// //doesn't work
	}
